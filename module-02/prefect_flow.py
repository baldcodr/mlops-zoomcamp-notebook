...
def main(train_path: str ="../module-01/data/green_tripdata_2022-01.parquet",
         val_path: str="../module-01/data/green_tripdata_2022-02.parquet"):
    mlflow.set_tracking_uri("sqlite:///mlflow.db")
    mlflow.set_experiment("ny-taxi-experiment")
    X_train = read_dataframe(train_path)
    X_val = read_dataframe(val_path)
    X_train, y_train, X_val, y_val, dv = add_features(X_train,X_val).result()
